...
class LanguagesPages {
  ...
  List<String> arWords = ["تسجيل","اشتراك","نسيت كلمة السر"," البريد ","بريد أو كلمة مرورغير صحيحة","البريد الألكتروني غير صحيح","كلمة السر غير مطابقة","طول كلمة المرور 7 أحرف كحد أدنى","خطأ غير معروف","تحقق من عنوان بريدك الإلكتروني ، واتبع الرابط لإعادة تعيين كلمة المرور الخاصة بك","البريد الإلكتروني","كلمه السر","تأكيد كلمة المرور","نسيت كلمة السر","تحيين كلمة السر","الرمز","تحقق","الصوره الشخصيه","قم بزيارة الموقع",];
